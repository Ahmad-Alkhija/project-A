				...
				<div class="col-lg-6 col-md-10">
					<div class="card">
						...
						<div class="card-body p-5">
                            ...
                            @endif
							<h4 class="mb-5" style="color:white; text-align:center;">Sign In</h4>

                            <form action="{{route('auth.check')}}" method="post">
                                @csrf
								<div class="row">
									<div class="form-group col-md-12 mb-4">
										<input type="email" class="form-control" id="email" name="email" placeholder="Username" value="{{old('email')}}">
